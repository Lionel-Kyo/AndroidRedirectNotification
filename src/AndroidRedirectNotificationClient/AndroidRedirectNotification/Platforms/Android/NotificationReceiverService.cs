...
#pragma warning disable CA1416
        if (Build.VERSION.SdkInt >= BuildVersionCodes.Tiramisu)
        {
            ...
            if (picture != null)
                pictureBase64 = BitmapToBase64(picture, Bitmap.CompressFormat.Jpeg!, 80);
            ...
            if (pictureIcon != null)
            {
                ...
                {
                    pictureIconBase64 = BitmapToBase64(bd.Bitmap, Bitmap.CompressFormat.Jpeg!, 80);
                }
            }
        }
...
#pragma warning disable CA1416
            ...
            if (channel != null && channel.Importance != NotificationImportance.Unspecified)
            {
